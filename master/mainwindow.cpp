...
void MainWindow::SlotUpdatePos(DEVICE_CODE id, AXIS axis, int pos)
{
    if (id == LOW_STAGE_CODE) {
        switch (axis) {
        case AXIS_X:
            ui->xAxisPosSpinBox->setValue(pos / 500.0);
            break;
        case AXIS_Y:
            ui->yAxisPosSpinBox->setValue(pos / 500.0);
            break;
        case AXIS_Z:
            ui->zAxisPosSpinBox->setValue(pos / 500.0);
            break;
        default:;
        }
    } else {
        switch (axis) {
        case AXIS_X:
            ui->xAxisPosSpinBoxHigh->setValue(pos / 3200.0);
            break;
        case AXIS_Y:
            ui->yAxisPosSpinBoxHigh->setValue(pos / 3200.0);
            break;
        case AXIS_Z:
            ui->zAxisPosSpinBoxHigh->setValue(pos / 10.0);
            break;
        default:;
        }
    }
...
{
    pULab->GotoHole(ui->addr1Box->value(),
                    ui->hole1ComboBox->currentText().toUInt(),
                    ui->pump1idSpinBox->value());
}

void MainWindow::on_valve2GoButton_clicked()
{
    pULab->GotoHole(ui->addr2Box->value(),
                    ui->hole2ComboBox->currentText().toUInt(),
                    ui->pump1idSpinBox->value());
}
...
{
    pULab->Rotate(true,
                  ui->pump2DirectionComboBox->currentIndex() == 0,
                  ui->pump2idSpinBox->value());
...
{
    pULab->Rotate(true,
                  ui->pump1DirectionComboBox->currentIndex() == 0,
                  ui->pump1idSpinBox->value());
...
void MainWindow::on_xAxisLowBox_clicked(bool checked)
{
    ...
    ReceiveMessage(QString("X-axis Low-precision stage has been ")
...
void MainWindow::on_yAxisLowBox_clicked(bool checked)
{
    ...
    ReceiveMessage(QString("Y-axis Low-precision stage has been ")
                   + (checked ? "enabled" : "disabled"));
}
...
void MainWindow::on_zAxisLowBox_clicked(bool checked)
{
    ...
    ReceiveMessage(QString("Z-axis Low-precision stage has been ")
                   + (checked ? "enabled" : "disabled"));
}
...
void MainWindow::on_xAxisHighBox_clicked(bool checked)
{
    ...
    ReceiveMessage(QString("X-axis High-precision stage has been ")
                   + (checked ? "enabled" : "disabled"));
}
...
void MainWindow::on_yAxisHighBox_clicked(bool checked)
{
    ...
    ReceiveMessage(QString("Y-axis High-precision stage has been ")
                   + (checked ? "enabled" : "disabled"));
}
...
void MainWindow::on_zAxisHighBox_clicked(bool checked)
{
    ...
    ReceiveMessage(QString("Z-axis High-precision stage has been ")
                   + (checked ? "enabled" : "disabled"));
}
